...
Run the project's pre-commit checklist. Execute these steps sequentially and stop on the first failure:
...
Report a summary of results. If any step fails, show the failure details and do not proceed to later steps.
